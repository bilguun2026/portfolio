...
const Flashcard: FC<FlashcardProps> = ({ question, answer, onDelete }) => {
  return (
    <div className="border py-4 px-6 rounded-lg bg-white w-full flex flex-row items-center shadow-md my-2">
      <div className="w-2/5 flex flex-col">
        <h3 className="font-semibold text-lg mb-2">Түлхүүр үг:</h3>
        <p className="text-gray-700">{question}</p>
      </div>
      <div className="w-3/5 flex flex-col">
        <h3 className="font-semibold text-lg mb-2">Хариулт:</h3>
