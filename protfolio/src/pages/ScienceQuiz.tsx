...
const ScienceQuizPage: React.FC = () => {
  const ScienceQuizzes = quizData.filter(
  ...
  const handleAnswerSelected = () => {
    if (currentQuizIndex + 1 < ScienceQuizzes.length) {
  ...
  return (
    <>
      ...
      {currentQuizIndex < ScienceQuizzes.length && (
        <Quiz
          quiz={ScienceQuizzes[currentQuizIndex]}
